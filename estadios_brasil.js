...
window.ESTADIO_MANDANTE_PADRAO_FPF = {
  ...
  // Clubes da Copa Paulista / Copa Paulista Feminino / código FPF 238,
  // pesquisados manualmente (jul/2026) para reduzir jogos "sem estádio".
  "ec xv piracicaba": { nome: "Estádio Barão de Serra Negra", cidade: "Piracicaba", regiao: "São Paulo", lat: -22.7253, lng: -47.6492 },
  "portuguesa saf": { nome: "Estádio Comendador Souza (Canindé)", cidade: "São Paulo", regiao: "São Paulo", lat: -23.5217, lng: -46.6297 },
  "go audax": { nome: "Estádio Municipal José Liberatti", cidade: "Osasco", regiao: "São Paulo", lat: -23.5325, lng: -46.7917 },
  "ferroviaria saf": { nome: "Estádio Municipal Olivério Bazzani Filho (Fonte Luminosa)", cidade: "Araraquara", regiao: "São Paulo", lat: -21.7845, lng: -48.1749 },
  "sao caetano fl": { nome: "Estádio Municipal Anacleto Campanella", cidade: "São Caetano do Sul", regiao: "São Paulo", lat: -23.6301, lng: -46.5599 },
  "marilia ac": { nome: "Estádio Bento de Abreu Sampaio Vidal (Abreuzão)", cidade: "Marília", regiao: "São Paulo", lat: -22.2153, lng: -49.9455 },
  "sao jose ec s a f": { nome: "Estádio Municipal Martins Pereira", cidade: "São José dos Campos", regiao: "São Paulo", lat: -23.1885, lng: -45.8699 },
  "comercial fc rp": { nome: "Estádio Doutor Francisco de Palma Travassos", cidade: "Ribeirão Preto", regiao: "São Paulo", lat: -21.1869, lng: -47.7878 },
  "ec sao bernardo saf": { nome: "Estádio Municipal Primeiro de Maio", cidade: "São Bernardo do Campo", regiao: "São Paulo", lat: -23.6999, lng: -46.5564 },
  "uniao sao joao ec": { nome: "Estádio Doutor Hermínio Ometto (Herminião)", cidade: "Araras", regiao: "São Paulo", lat: -22.3593, lng: -47.3406 },
  "gremio prudente": { nome: "Estádio Paulo Constantino (Prudentão)", cidade: "Presidente Prudente", regiao: "São Paulo", lat: -22.1256, lng: -51.3894 },
  "ca linense": { nome: "Estádio Gilberto Siqueira Lopes (Gilbertão)", cidade: "Lins", regiao: "São Paulo", lat: -21.6795, lng: -49.7431 },
  "ec sao bento": { nome: "Estádio Municipal Walter Ribeiro (CIC)", cidade: "Sorocaba", regiao: "São Paulo", lat: -23.4936, lng: -47.4581 },
  "bandeirante ec": { nome: "Estádio Pedro Marin Berbel", cidade: "Birigui", regiao: "São Paulo", lat: -21.2887, lng: -50.3403 },
  "ec noroeste": { nome: "Estádio Doutor Alfredo de Castilho (Alfredão)", cidade: "Bauru", regiao: "São Paulo", lat: -22.3147, lng: -49.0736 },
  "ec santo andre": { nome: "Estádio Bruno José Daniel", cidade: "Santo André", regiao: "São Paulo", lat: -23.6513, lng: -46.5306 },
  "juventus saf": { nome: "Estádio Rua Javari (Conde Rodolfo Crespi)", cidade: "São Paulo", regiao: "São Paulo", lat: -23.5613, lng: -46.6067 },
  "paulista fc": { nome: "Estádio Doutor Jaime Cintra", cidade: "Jundiaí", regiao: "São Paulo", lat: -23.1857, lng: -46.8978 },
  "primavera saf": { nome: "Estádio Municipal de Indaiatuba", cidade: "Indaiatuba", regiao: "São Paulo", lat: -23.0879, lng: -47.2119 },
  "osasco sporting": { nome: "Sede do Osasco Sporting Clube", cidade: "Osasco", regiao: "São Paulo", lat: -23.5325, lng: -46.7917 },
  "ad centro olimpico": { nome: "Sede do AD Centro Olímpico", cidade: "São Paulo", regiao: "São Paulo", lat: -23.5505, lng: -46.6333 },
  "brothers fc": { nome: "Sede do Brothers FC", cidade: "São Paulo", regiao: "São Paulo", lat: -23.5505, lng: -46.6333 },
  "se lemense ff": { nome: "Sede do SE Lemense", cidade: "Leme", regiao: "São Paulo", lat: -22.1889, lng: -47.3853 },
  // SE Palmeiras, Santos FC, São Paulo FC, Red Bull Bragantino, Corinthians:
  // clubes grandes que também aparecem no código FPF 238 (torneio de base
  // interestadual). Usa o estádio principal de cada um.
  "se palmeiras": { nome: "Allianz Parque", cidade: "São Paulo", regiao: "São Paulo", lat: -23.5273, lng: -46.6788 },
  "santos fc": { nome: "Estádio Urbano Caldeira (Vila Belmiro)", cidade: "Santos", regiao: "São Paulo", lat: -23.9489, lng: -46.3353 },
  "sao paulo fc": { nome: "Estádio Cícero Pompeu de Toledo (Morumbi)", cidade: "São Paulo", regiao: "São Paulo", lat: -23.6003, lng: -46.7194 },
  "red bull bragantino": { nome: "Estádio Nabi Abi Chedid", cidade: "Bragança Paulista", regiao: "São Paulo", lat: -22.9526, lng: -46.5411 },
  "sc corinthians pta": { nome: "Neo Química Arena", cidade: "São Paulo", regiao: "São Paulo", lat: -23.5449, lng: -46.4728 },
  // Clubes de fora de SP que aparecem no código FPF 238 (torneio de base):
  // usa os mesmos estádios já cadastrados para FFERJ/Minas Gerais.
  "fluminense": { nome: "Estádio Jornalista Mário Filho (Maracanã)", cidade: "Rio de Janeiro", regiao: "Rio de Janeiro", lat: -22.9121, lng: -43.2302 },
  "vasco": { nome: "Estádio São Januário", cidade: "Rio de Janeiro", regiao: "Rio de Janeiro", lat: -22.8917, lng: -43.2286 },
